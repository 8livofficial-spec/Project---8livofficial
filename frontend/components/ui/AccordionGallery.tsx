...
const DEFAULT_ITEMS: AccordionGalleryItem[] = [
  { image: '/images/meal_indian.png', label: 'Indian Cuisine Blueprint', link: '#' },
  { image: '/images/meal_prep.png', label: 'Glycemic Stability', link: '#' },
  { image: '/images/nutrition_indian.png', label: 'Daily Metabolic Routine', link: '#' },
  { image: '/images/nutrition_lifestyle.png', label: '1-on-1 Clinical Guidance', link: '#' },
  { image: '/images/hero_wellness.png', label: 'Long-term Habit Mastery', link: '#' }
]
