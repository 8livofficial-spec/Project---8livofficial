...
@app.get("/api/cron/scheduler")
async def run_scheduler_cron():
    print("[SCHEDULER CRON] Executing scheduler checks...")
    try:
    ...
    return {"status": "success", "message": "Cron scheduler ran successfully"}
